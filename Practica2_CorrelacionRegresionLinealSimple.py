...
#Quitad los NaN que hay en el dataset(eliminan filas nulas )
...
ax.plot(predicciones['x'], prediccione´´s["mean_ci_upper"], linestyle='--', color='red')
...
mpg = mpg.dropna()
plt.scatter(mpg.horsepower, mpg.acceleration)
#¿Es razonable predecir la potencia de un coche de esta muestra en función de 
#su aceleración, o viceversa? Justifica tu respuesta. 


#respuesta: Sí. por que a mayor aceleación mayor potencia 


# In[13]:


#Utilizando la recta de regresión adecuada, ¿qué potencia se prevé para un coche que tenga una aceleración de 10 segundos?


# In[ ]:


#Utilizando la recta de regresión adecuada, ¿qué aceleración se prevé para un coche que tenga una potencia de 10 Cv?
modelo.params[0]+modelo.params[1]*10
